...
export default function StatCard({ title, value, subtext, trend, active, reinsurerstatus }) {
  ...
  return (
    <div
      className={`p-5 rounded-3xl transition-all cursor-pointer hover:shadow-xl ${active
    ...
    >
      <div className="flex justify-between items-start mb-4">
        ...
        {/* <div className={`w-8 h-8 rounded-full flex items-center justify-center ${active
            ? 'bg-white/20'
      ...
      {reinsurerstatus != undefined && reinsurerstatus != '' && reinsurerstatus != null ? <div className="flex items-center gap-2">
        <span className={`text-xs px-1.5 py-0.5 rounded ${active
          ? 'bg-white/20 text-white'
          : 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400'
          }`}>
          {reinsurerstatus}
