  ...
  return (
    <>
      <header className="flex items-center justify-between gap-4 mb-8">
        ...
        <button
          ...
          {/* <div className="w-20 h-20 flex items-center justify-center">
            <img src='./images/logo-SVG.svg'></img>
          </div> */}
          {/* Search Bar - Desktop */}
          <button
            onClick={() => {
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative" ref={profileRef}>
            ...
            >
              <div className="rounded-full object-cover border-2 border-white shadow-sm" style={{ width: '30px' }}>
                <Image src="/images/JA_LOGO.jpg" alt="Logo" width={80} height={20} />
              </div>
              {/* <img
                src="./images/JA_LOGO.jpg"
                alt="Profile"
                className="w-10 h-10 rounded-full object-cover border-2 border-white shadow-sm"
              /> */}
              {/* <div className="w-10 h-10 rounded-full object-cover border-2 bg-gray-50 border-white shadow-sm"></div> */}
            ...
            {(profileOpen || profileClosing) && (
              <div className={`absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-100 dark:border-gray-700 z-50 origin-top-right ${profileClosing ? 'animate-dropdownSlideOut' : 'animate-dropdownSlideIn'
                }`}>
                <div className="p-4 border-b border-gray-100 dark:border-gray-700">
                  <p className="font-semibold text-gray-800 dark:text-gray-200">SuperAdmin</p>
      ...
      {(searchOpen || searchClosing) && (
        <div
          className={`fixed inset-0 bg-black/50 dark:bg-black/70 z-50 flex items-start justify-center pt-20 px-4 ${searchClosing ? 'animate-fadeOut' : 'animate-fadeIn'
            }`}
          onClick={() => closeWithAnimation(setSearchOpen, setSearchClosing)}
        >
          <div
            className={`bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-2xl ${searchClosing ? 'animate-modalSlideOut' : 'animate-modalSlideIn'
              }`}
