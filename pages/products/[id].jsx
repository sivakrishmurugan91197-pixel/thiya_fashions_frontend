...
export default function ProductDetails() {
    ...
    return (
        <ThiyaLayout>
            ...
            {orderSuccessDetails && (
                <div className="fixed inset-0 z-[110] flex items-center justify-center bg-neutral-900/80 backdrop-blur-md p-4 overflow-y-auto animate-fade-in">
                    <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-8 border border-neutral-100 text-center relative overflow-hidden animate-in fade-in zoom-in-95 duration-300">
                        ...
                        <div className="bg-neutral-50 rounded-2xl p-6 border border-neutral-150 text-left space-y-4 mb-8">
                            ...
                            <div className="text-sm text-neutral-700 space-y-2.5">
                                <div className="flex justify-between items-start">
                                    ...
                                    <span className="font-bold text-neutral-900 text-right max-w-[200px] truncate" title={orderSuccessDetails.productTitle}>{orderSuccessDetails.productTitle}</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-neutral-500 font-medium">Quantity:</span>
                                    <span className="font-bold text-neutral-900">{orderSuccessDetails.quantity}</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-neutral-500 font-medium">Amount Paid:</span>
                                    <span className="font-black text-neutral-900">₹{orderSuccessDetails.amountPaid.toFixed(2)}</span>
                                </div>
                                <div className="flex flex-col pt-3 border-t border-neutral-200 gap-1.5">
                                    ...
                                    <span className="font-mono text-[11px] sm:text-xs text-neutral-700 bg-white border border-neutral-200 px-3 py-2.5 rounded-lg flex items-center justify-between select-all leading-none font-bold">
                                        {orderSuccessDetails.transactionId}
